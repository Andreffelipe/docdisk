...
commander_1.default
    ...
    .action(function (linguagem, options) { return __awaiter(void 0, void 0, void 0, function () {
    var topic;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!options.topic) return [3 /*break*/, 2];
                return [4 /*yield*/, topic_1.default(linguagem)];
            case 1:
                topic = _a.sent();
                _a.label = 2;
            case 2:
                documentation_1.default(linguagem, options.topic || (topic === null || topic === void 0 ? void 0 : topic.language));
                return [2 /*return*/];
        }
    });
}); });
